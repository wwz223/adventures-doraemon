...
public class Eater extends EaterAndEnemy{
	...
	/*构造方法*/
	public Eater(){
		this.x = 13*20+GameBoard.marginX;
		this.y = 20*20+GameBoard.marginY;
	}
	...
	public boolean hitEnemy(Enemy enemy) {
		int x1 = this.x - enemy.getWidth()+5;
		int x2 = this.x + this.width - 5;
		int y1 = this.y - enemy.getHeight()+5;
		int y2 = this.y + this.height - 5;
